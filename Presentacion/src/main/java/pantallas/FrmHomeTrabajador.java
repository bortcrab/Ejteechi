...
public class FrmHomeTrabajador extends javax.swing.JFrame {
    ...
    private void lblRegistrarMouseClicked(java.awt.event.MouseEvent evt) {                                       
    ...
    private void lblRegistrar1MouseClicked(java.awt.event.MouseEvent evt) {
        FrmRegistrarEmpleado frmRegistrar = new FrmRegistrarEmpleado(); // Se muestra un mensaje si no se validó la sesión.
        frmRegistrar.setVisible(true);
        this.dispose();
    }
    
    private void lblRegistrarEntered(java.awt.event.MouseEvent evt) {
